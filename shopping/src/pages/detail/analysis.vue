...
export default {
  ...
  methods: {
    onParamChange (attr, val) {
        log('改变了onParamChange')
      this[attr] = val
      log('attr: ' + attr)
      log('val: ' + JSON.stringify(val))
      log(`this[attr]: ${ this[attr] }`)
      this.getPrice()
    },
    getPrice () {
      ...
      log(JSON.stringify(reqParams))
//    this.$http.post('/api/getPrice', reqParams)
      this.$http.get('/apis/api/testData', reqParams)
      .then((res) => {
          var data =res.data.getPrice
